        ...
        <div class="col-md-10">
          ...
          <div class="tile">
            <h3 class="tile-title">Add New Menu</h3>
             <form action="{{route('insertmenu')}}" method="post">
             	@csrf
	            <div class="tile-body">
                <div class="form-group">
                  <label class="control-label">Menu Name</label>
                  <input type="text" class="form-control"  placeholder="Menu name" name="menu_name" value="{{old('menu_name')}}">
               ...
               <label class="control-label">Menu URL</label>
                <div class="input-group mb-2 mr-sm-2">
                  ...
                  <input type="text" class="form-control" id="url" placeholder="URl" name="menu_url" value="{{old('menu_url')}}">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" max="10"  min="0" name="menu_si" value="{{old('menu_si')}}">
                 ...
                 <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="menu_display">
                      ...
                      <option value="00">sidebar</option>
                    </select>
